...
export const getSlotCountForPlan = (plan: PlanType): number => {
  switch (plan) {
    ...
    case PlanType.EIGHT_HOURS: return 1; // Simplified for grid logic, effectively takes a slot
    case PlanType.FOURTEEN_HOURS: return 2;
