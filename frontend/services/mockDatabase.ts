...
let announcement: GlobalAnnouncement = loadJSON(KEY_ANNOUNCEMENT, { message: '', isActive: false, updatedAt: '', type: 'ALERT' });
...
export const MockService = {
  ...
  setAnnouncement: (message: string, isActive: boolean, type: 'ALERT' | 'NOTIFICATION' = 'ALERT') => {
    announcement = { message, isActive, type, updatedAt: new Date().toISOString() };
