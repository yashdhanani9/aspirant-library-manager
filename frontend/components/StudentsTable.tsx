...
export const StudentsTable: React.FC<StudentsTableProps> = ({ students, seats, onEdit, onViewDocs }) => {
    ...
    const downloadStudentPDF = (student: Student) => {
        ...
        addRow("Amount Paid", `Rs. ${student.amountPaid}`);

        // ID Type Logic
        const idType = student.idProofType && student.idProofType.length > 0 ? student.idProofType : "Not Specified";
        addRow("ID Proof Type", idType);
